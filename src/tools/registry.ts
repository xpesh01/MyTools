...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    title: 'SVG из текста',
    description:
      'Находит все SVG во вставленном тексте или загруженном файле, показывает их и даёт скачать каждый.',
    category: 'images',
    keywords: ['svg', 'иконки', 'превью', 'вектор', 'скачать', 'извлечь', 'лог', 'файл'],
